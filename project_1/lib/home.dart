...
class _HomePageState extends State<HomePage> {
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        ...
        UserAccountsDrawerHeader(
          accountName: Text('Phạm Hải Phong',
              style: TextStyle(
          ...
          currentAccountPicture:
              CircleAvatar(backgroundImage: AssetImage('Image/ava.jpeg')),
  ...
  void importantHomePage() {
    Navigator.push(context, MaterialPageRoute(builder: gotoimportant));
  }
  ...
  void myDay() {
    Navigator.push(context, MaterialPageRoute(builder: gotomyDay));
  }
  ...
  void myPlaned() {
    Navigator.push(context, MaterialPageRoute(builder: gotomyplaned));
  }
  ...
  void myWork() {
    Navigator.push(context, MaterialPageRoute(builder: gotomywork));
  }
  ...
  void myTask() {
    Navigator.push(context, MaterialPageRoute(builder: gotomytask));
  }
  ...
  void myacc() {
    Navigator.push(context, MaterialPageRoute(builder: gotomyacc));
  }
  ...
  void changepass() {
    Navigator.push(context, MaterialPageRoute(builder: gotomychangepass));
  }
  ...
  void moreinfo() {
    Navigator.push(context, MaterialPageRoute(builder: gotomymoreinfo));
  }
  ...
  exit() async {
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => Home_login_Page()));
  }
}
